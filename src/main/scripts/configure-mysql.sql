...
CREATE USER 'dev_user'@'localhost' IDENTIFIED BY 'cimspace';
CREATE USER 'prod_user'@'localhost' IDENTIFIED BY 'cimspace';
CREATE USER 'dev_user'@'%' IDENTIFIED BY 'cimspace';
CREATE USER 'prod_user'@'%' IDENTIFIED BY 'cimspace';
